...
//    @NotEmpty
    ...
    @Builder
    public UserRequestDto(Long userId, String username, String password, String lastName, String firstName, String nickName, String phoneNum, int gender, Authority authority, String authKey) {
        this.userId = userId;
